...
// first step to create enum class to define each screen Route name
enum class CupcakeScreen(@StringRes val tittle: Int) {
...
fun CupcakeAppBar(
    ...
    TopAppBar(
        title = { Text(stringResource(currentScreen.tittle)) },
        modifier = modifier,
        navigationIcon = {
            if (canNavigateBack) {
